...
当前维护线从 Minecraft `1.21` 系列开始，包含 `1.21.1`、`1.21.3`、`1.21.4`、`1.21.5`、`1.21.8`、`1.21.10`、`1.21.11`、`26.1.2` 和 `26.2` 共 9 个构建平台，覆盖 Minecraft `1.21`-`1.21.11` 与 `26.1`-`26.2` 之间的全部兼容版本。Minecraft `1.21` 与 `1.21.1` 共用标记为 `mc1.21-1.21.1` 的发行 JAR，不提供独立 `mc1.21` 构建。Minecraft `1.21` 以下版本已停止维护，请从历史 Release 下载对应 Minecraft 版本的最后兼容版本。
