...
当前版本为 `1.5.1`，提供 Minecraft `1.16.5`、`1.17.1`、`1.18.2`、`1.19.2`、`1.19.4`、`1.20.1`、`1.20.4`、`1.20.6`、`1.21`、`1.21.1`、`1.21.4`、`1.21.5`、`1.21.8`、`1.21.10`、`1.21.11`、`26.1.2` 和 `26.2`。
...
- Minecraft `1.21.1` 附魔等级扩展：`enchantmentLevelLimitIncrease` 可统一增加附魔原版上限，`enchantmentLevelAddition` 可让铁砧按 `2+2=4` 的方式直接相加等级
