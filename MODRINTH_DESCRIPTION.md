...
Version `1.5.1` is available for Minecraft `1.16.5`, `1.17.1`, `1.18.2`, `1.19.2`, `1.19.4`, `1.20.1`, `1.20.4`, `1.20.6`, `1.21`, `1.21.1`, `1.21.4`, `1.21.5`, `1.21.8`, `1.21.10`, `1.21.11`, `26.1.2`, and `26.2`.
...
- Minecraft `1.21.1`: `enchantmentLevelLimitIncrease` raises vanilla enchantment maxima, while `enchantmentLevelAddition` makes anvil combinations add matching levels directly, such as 2+2=4.
...
- Minecraft `1.21-26.2`: core fake-player sorting with offline `quickopen`, online `summon`, whitelist, names, and shulker handling; `1.21.1` additionally keeps restock, rebuild, disk cache, worker tuning, and Dashboard/API features.
