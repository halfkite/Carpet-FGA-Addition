...
当前版本提供 Minecraft `1.16.5`、`1.17.1`、`1.18.2`、`1.19.2`、`1.19.4`、`1.20.1`、`1.20.4`、`1.20.6`、`1.21`、`1.21.1`、`1.21.3`、`1.21.4`、`1.21.5`、`1.21.8`、`1.21.10`、`1.21.11`、`26.1.2` 和 `26.2`。Minecraft `1.21` 与 `1.21.1` 共用标记为 `mc1.21-1.21.1` 的发行 JAR，不再提供独立 `mc1.21` 构建。
