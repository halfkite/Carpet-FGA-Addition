...
仓库的正式发布由 `.github/workflows/release.yml` 负责。它会按照 `build.gradle` 中的发布矩阵构建 Minecraft `1.20.1`、`1.21`、`1.21.1`、`1.21.2-1.21.3`、`1.21.4`、`1.21.5`、`1.21.6-1.21.8`、`1.21.9-1.21.10`、`1.21.11`、`26.1-26.1.2` 和 `26.2`。
