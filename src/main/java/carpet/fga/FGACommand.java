...
public final class FGACommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        //#if MC >= 1.21 && MC <= 26.3
        redirect(root, "food", dispatcher);
        redirect(root, "piglinBarterItemExclusions", dispatcher);
        //#endif
        //#if MC >= 1.21 && MC <= 26.3
    ...
    private static int help(com.mojang.brigadier.context.CommandContext<CommandSourceStack> context) {
        ...
        //#if MC == 1.21.1
        line(out, "/fga food clear [玩家]", "清空饱食度和饱和度 / clear food and saturation");
        //#endif
        //#if MC >= 1.21 && MC <= 26.3
        if (PiglinBarterCustomizationManager.enabled()) {
            line(out, "/fga piglinBarterItemExclusions list", "猪灵交易物品自定义 / piglin barter customization");
        }
        //#endif
        //#if MC >= 1.20.1 && MC <= 26.3
